...
%nu_list = [1e-2 1e-1 1e0 1e1 1e2];
nu_list = [1e-1 5e-1 1e0 5e0 1e1];
...
for inu = 1:Nnu
    ...
    loglog(time,...
        ...
        'LineWidth',4,...
        'DisplayName',...
        ['\nu = ',num2str(nu_list(inu))])
hold on

end

 loglog(time(1:100), 4.2* time(1:100).^(1/3),':k', 'LineWidth',4, ...
     'DisplayName','t^{1/3}')
xlabel('t')
